...
int main (void)
{
  ...
  printf("(n=32) La integral dóna (TRAPEZIS SIMPLE) \t%.8G i la cota de l'error és \t%.8G\n",integral,error);
  printf("(n=32) La integral dóna (TRAPEZIS COMPOST) \t%.8G i la cota de l'error és \t%.8G\n",integral2,error2);
  return 0;
}