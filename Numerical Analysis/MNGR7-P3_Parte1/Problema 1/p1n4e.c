...
int main (void)
{
  int i,j,n=4,np=180,index=0;
  double err=0; /*variable que emmagatzema el valor de l'error màxim comès*/
  ...
  for(j=0;j<=np;j++)/*Funció que selecciona el valor major que es comet*/
  {
